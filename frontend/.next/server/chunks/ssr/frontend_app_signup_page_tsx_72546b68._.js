...
function SignupPage() {
    ...
    const handleSignup = async (e)=>{
        ...
        setError(null);
        setSuccess(null);
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
            email,
            password
        });
        if (error) {
...
//# sourceMappingURL=frontend_app_signup_page_tsx_72546b68._.js.map