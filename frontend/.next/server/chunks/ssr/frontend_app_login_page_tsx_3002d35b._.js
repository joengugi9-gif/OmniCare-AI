...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        e.preventDefault();
        setError(null);
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
            email,
            password
        });
        if (error) {
...
//# sourceMappingURL=frontend_app_login_page_tsx_3002d35b._.js.map