...
function ProtectedRoute(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProtectedRoute.useEffect": ()=>{
            const session = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession().then({
                "ProtectedRoute.useEffect.session": (param)=>{
                    let { data } = param;
                    if (!data.session) {
            ...
            }["ProtectedRoute.useEffect.session"]);
        }
    }["ProtectedRoute.useEffect"], [
        router
    ]);
...
//# sourceMappingURL=frontend_components_ProtectedRoute_tsx_81c164e2._.js.map